                ...
                <div class="relative overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td></td>
                            <td class="px-6 py-4 {{ $totalProfit < 0 ? 'text-red-500' : 'text-green-500' }} font-bold">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-2 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div style="text-align: center;">
                    <div class="mb-2" id="coinmarketcap-widget-coin-price-block"
                         coins="1,1027,825,1839,52,3408,2010" currency="EUR"
